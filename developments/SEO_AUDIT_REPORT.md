...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive Indonesian holiday calendar with national holidays...',
  keywords: ['holiday', 'calendar', 'indonesia', 'libur', 'nasional'],
  openGraph: { /* comprehensive OG tags */ },
  twitter: { /* Twitter Card setup */ },
...
const holidayKeywords = {
  'independence-day': [
    'hari kemerdekaan indonesia', 'agustus 2025', '17 agustus', 
    'kemerdekaan ri', 'dirgahayu indonesia'
  ],
  'eid-al-fitr': [
    'idul fitri 2025', 'lebaran 2025', 'hari raya', 
    'mudik lebaran', 'libur lebaran panjang'
  ]
}
```
