...
/**
 * Regional holidays for 2024
 * These are province or region-specific holidays
 */
export const regionalHolidays2024: Holiday[] = [
  // DKI Jakarta
  {
    id: 'jakarta-anniversary-2024',
    name: {
  ...
  // Yogyakarta
  {
    id: 'yogyakarta-anniversary-2024',
    name: {
  ...
  // Central Java
  {
    id: 'central-java-anniversary-2024',
    name: {
